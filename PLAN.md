...
| 11 | Convert class components to functions and extract their input rules | Structural | specifier -> coder -> cleaner -> architect -> hardener -> QA | **done** |
| 12 | Replace connect() containers with react-redux hooks | Structural | specifier -> coder -> cleaner -> architect -> hardener -> QA | in progress |
