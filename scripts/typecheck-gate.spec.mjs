 ...
 *
 * The expected line names all four projects, so dropping one - this file's own
  ...
  it(
    ...
    () => {
      ...
      expect(fromRoot.stdout).toBe(
        '0 error(s) in tsconfig.json, qa/tsconfig.json, acceptance/tsconfig.json, tsconfig.tools.json\n',
      )
