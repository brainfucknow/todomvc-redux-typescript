 ...
 *
 * Four projects, because no file in this repository should sit outside all of
 * them: the app, the QA suite, the acceptance pipeline's runtime and step
 * handlers, and the tooling - which includes this script and the gate module it
 * imports, so the thing deciding whether the project typechecks is itself
 * typechecked.
 *
